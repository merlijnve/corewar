...
/*   Updated: 2020/09/17 13:51:36 by floris        ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
size_t			ft_strcnt(const char *s1, int c);
size_t			ft_strncnt(const char *s1, int c, size_t len);
...
typedef struct s_hdict	t_hdict;
typedef struct s_hpair	t_hpair;

typedef struct s_hlist	t_hlist;
